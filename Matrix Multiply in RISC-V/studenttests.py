...
class TestAbsLoss(unittest.TestCase):
    ...
    def test_length_0(self):
        ...
        # call the `abs_loss` function
        t.call("abs_loss")
        # generate the `assembly/TestAbsLoss_test_length_0.s` file and run it through venus
        t.execute(code=36)
...
class TestSquaredLoss(unittest.TestCase):
    def test_simple(self):
        ...
        # check that the register a0 contains the correct output
        t.check_scalar("a0", 4)
        # generate the `assembly/TestSquaredLoss_test_length_0.s` file and run it through venus
        t.execute()
...
class TestZeroOneLoss(unittest.TestCase):
    ...
    def test_length_0(self):
        ...
        # call the `zero_one_loss` function
        t.call("zero_one_loss")
        # generate the `assembly/TestZeroOneLoss_test_length_0.s` file and run it through venus
        t.execute(code=36)
...
class TestInitializeZero(unittest.TestCase):
    ...
    def test_length_0(self):
        ...
        # call the `initialize_zero` function
        t.call("initialize_zero")
        # generate the `assembly/TestInitializeZero_test_length_0.s` file and run it through venus
        t.execute(code=36)
    ...
    def test_malloc_error(self):
        ...
        # call the `initialize_zero` function
        t.call("initialize_zero")
        # generate the `assembly/TestInitializeZero_test_malloc_error.s` file and run it through venus
